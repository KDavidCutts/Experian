      ...
      * Strings used to display output      
       01 WS-DISP-STRINGS.
      ...
      * Toatls of denominations used in the change amount        
      ...
      * Display messages and accept inputs, performing limited validation
      ...
      * Divide the change amount by the various denominations to calculate the number of 
      * the denominations required
      ...
      * Use a subscript to check all the denominations and output only those required
